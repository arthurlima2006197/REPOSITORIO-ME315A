...
Resposta: Sim, pois pelas propriedades distributivas, os argumentos se relacionam da mesma forma nas duas linhas de código abaixo.
...
Resposta: As linhas 1 e 3 são logicamente equivalentes, pois avaliam a intersecção dos eventos. A linha 2 se difere das outras pois apresenta uma lógica mais restritiva, pois avalia os eventos individualmente e em conjunto.
...
Resposta: as linhas 1 e 3 são logicamente equivalentes, pois apresentam a distribuição correta da propriedade de negação para esse caso, já a linha 2 se difere das demais pois filtra os dados de forma menos restritiva, mais excludente.
